...
urlpatterns = [
    ...
    url(r'^extensions$', views.extensions),
    url(r'^genieacs$', views.genieacs, name="genieacs"),
    url(r'^genieacs_log$', views.genieacs_log, name="genieacs_log"),
    # url(r'^genieacs_search$', views.genieacs_search, name="genieacs_search"),
