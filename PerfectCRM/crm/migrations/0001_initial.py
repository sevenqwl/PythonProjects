# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2019-02-07 04:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.ClassList', verbose_name='班级')),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name='courserecord',
            unique_together=set([('from_course', 'day_num')]),
        ),
        migrations.AlterUniqueTogether(
            name='classlist',
            unique_together=set([('branch', 'course', 'semster')]),
        ),
    ]
